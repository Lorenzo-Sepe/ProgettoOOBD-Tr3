package ImplementazioniDAOpostgreSQL;
...
public class ImplementazioneRubricaDAO implements RubricaDAO {
    ...
    public int addContattoDB(String prefisso, String nome, String cognome, String path) {
         ...
         int id=0;
        try {
            addContattoPS = connection.prepareStatement("INSERT INTO Contatto (prefisso_nome,nome,cognome,path_foto,password_cassaforte) VALUES (?,?,?,?,null) returning Contatto_id as ID");
